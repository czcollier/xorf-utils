...
public class GenericReflectionUtils {
    ...
    public abstract static class GenericParamWrapper<T> {
        private Iterable<T> wrapped;
        public GenericParamWrapper(Iterable<T> wrapped) {
            this.wrapped = wrapped;
        }
        
        public List<Class<?>> getTypeArguments() {
            return GenericReflectionUtils.getTypeArguments(GenericParamWrapper.class, getClass());
        }
    }
}
